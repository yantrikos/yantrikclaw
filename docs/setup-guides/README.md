...
| Scenario | Command |
|----------|---------|
| I have an API key, want fastest setup | `yantrikclaw onboard --api-key sk-... --provider openrouter` |
| I want guided prompts | `yantrikclaw onboard` |
| Config exists, just fix channels | `yantrikclaw onboard --channels-only` |
| Config exists, I intentionally want full overwrite | `yantrikclaw onboard --force` |
| Using subscription auth | See [Subscription Auth](../../README.md#subscription-auth-openai-codex--claude-code) |

## Onboarding and Validation

- Quick onboarding: `yantrikclaw onboard --api-key "sk-..." --provider openrouter`
- Guided onboarding: `yantrikclaw onboard`
...
- Validate environment: `yantrikclaw status` + `yantrikclaw doctor`
