# YantrikClaw Architecture Diagrams

This document provides visual representations of YantrikClaw's architecture, execution modes, and data flows.

---

## 1. Execution Modes

**Ways YantrikClaw can be run:**

```mermaid
flowchart TD
    Start[yantrikclaw CLI] --> Onboard[onboard<br/>Setup wizard]
...
```mermaid
flowchart TB
    Start[[yantrikclaw daemon]] --> SpawnComponents
...
```mermaid
flowchart TB
    Client[HTTP Client] --> Gateway[YantrikClaw Gateway]
...
flowchart TB
    ...
    Defaults --> EnvOverrides[apply_env_overrides<br/>YANTRIKCLAW_* env vars]
...
*Generated for YantrikClaw v0.1.0 - Architecture Documentation*
