...
Cách cài đặt và khởi tạo YantrikClaw nhanh nhất.
...
Mặc định là **chỉ ứng dụng** (build/cài YantrikClaw), yêu cầu Rust toolchain sẵn có.
...
Lệnh này build image YantrikClaw cục bộ và chạy thiết lập trong container, lưu config/workspace vào `./.yantrikclaw-docker`.
