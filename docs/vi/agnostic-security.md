...
|---------|-----------|--------------|--------|
| **YantrikClaw cơ bản** | 3.4MB | <5MB | ✅ Hiện tại |
...
| Phần cứng | RAM | YantrikClaw (cơ bản) | YantrikClaw (full security) | Trạng thái |
|----------|-----|-----------------|--------------------------|--------|
...
**Ngay cả với full security, YantrikClaw chỉ dùng <5% RAM trên board $10.**

---

## 5. Tính hoán đổi: mọi thứ vẫn pluggable

### Cam kết chính của YantrikClaw: hoán đổi bất kỳ thứ gì
