# Tài liệu tham khảo Providers — YantrikClaw
...
3. Biến môi trường dự phòng chung: `YANTRIKCLAW_API_KEY`, sau đó là `API_KEY`
...
- Sau khi chuẩn hóa multimodal, YantrikClaw gửi payload hình ảnh qua trường `messages[].images` gốc của Ollama.
- Nếu chọn provider không hỗ trợ vision, YantrikClaw trả về lỗi rõ ràng thay vì âm thầm bỏ qua hình ảnh.
...
- Khám phá model: `yantrikclaw models refresh --provider nvidia`
