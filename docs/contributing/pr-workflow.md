# YantrikClaw PR Workflow (High-Volume Collaboration)

This document defines how YantrikClaw handles high PR volume while maintaining:
...
- If identity-like wording appears in tests/examples, it is normalized to YantrikClaw/project-native labels.
...
- Confirm any required identity-like wording uses YantrikClaw/project-native terminology.
