...
```bash
# Check config
cat ~/.yantrikclaw/config.toml | grep -A 5 telegram
...
| Health check | <5s | `time yantrikclaw channel doctor` |
...
5. **Monitor logs** for any issues:
   ...
   yantrikclaw daemon
   # or
   RUST_LOG=info yantrikclaw channel start
   ```
...
- Issues: https://github.com/yantrikclaw-labs/yantrikclaw/issues
- Docs: [testing-telegram.md](../../tests/telegram/testing-telegram.md)
- Help: `yantrikclaw --help`
