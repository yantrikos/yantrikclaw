...
YantrikClaw's architecture is trait-driven and modular.
...
```rust
// In your crate: use yantrikclaw::tools::traits::{Tool, ToolResult};
...
Channels let YantrikClaw communicate through any messaging platform.
...
```rust
// In your crate: use yantrikclaw::channels::traits::{Channel, ChannelMessage, SendMessage};
...
Providers are LLM backend adapters. Each provider connects YantrikClaw to a different model API.
...
```rust
// In your crate: use yantrikclaw::providers::traits::Provider;
...
```rust
// In your crate: use yantrikclaw::memory::traits::{Memory, MemoryEntry, MemoryCategory};
