...
Rules for pull request quality, attribution, privacy, and handoff in YantrikClaw.
...
- If identity-like context is unavoidable, use YantrikClaw-scoped roles/labels only (e.g., `YantrikClawAgent`, `YantrikClawOperator`, `yantrikclaw_user`).
- Recommended identity-safe naming palette:
    - actor labels: `YantrikClawAgent`, `YantrikClawOperator`, `YantrikClawMaintainer`, `yantrikclaw_user`
    - service/runtime labels: `yantrikclaw_bot`, `yantrikclaw_service`, `yantrikclaw_runtime`, `yantrikclaw_node`
    - environment labels: `yantrikclaw_project`, `yantrikclaw_workspace`, `yantrikclaw_channel`
