...
## Problem
YantrikClaw logs actions but lacks tamper-evident audit trails for:
...
# Tamper evidence
sign_events = true
signing_key_path = "~/.config/yantrikclaw/audit.key"
...
yantrikclaw audit --user @alice

# Show all high-risk commands
yantrikclaw audit --risk high

# Show violations from last 24 hours
yantrikclaw audit --since 24h --violations-only

# Export to JSON for analysis
yantrikclaw audit --format json --output audit.json
