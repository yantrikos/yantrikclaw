# YantrikClaw Trademark Policy

**Effective date:** February 2026  
**Maintained by:** YantrikClaw Labs

---

## Our Trademarks

The following are trademarks of YantrikClaw Labs:

- **YantrikClaw** (word mark)
- **yantrikclaw-labs** (organization name)
- The YantrikClaw logo and associated visual identity

These marks identify the official YantrikClaw project and distinguish it from
...
The **only** official YantrikClaw repository is:

> https://github.com/yantrikclaw-labs/yantrikclaw

Any other repository, organization, domain, or product claiming to be
"YantrikClaw" or implying affiliation with YantrikClaw Labs is unauthorized and
may constitute trademark infringement.

**Known unauthorized forks:**
- `openagen/yantrikclaw` — not affiliated with YantrikClaw Labs

If you encounter an unauthorized use, please report it by opening an issue
at https://github.com/yantrikclaw-labs/yantrikclaw/issues.

---

## Permitted Uses

You **may** use the YantrikClaw name and marks in the following ways without
prior written permission:

1. **Attribution** — stating that your software is based on or derived from
   YantrikClaw, provided it is clear your project is not the official YantrikClaw.

2. **Descriptive reference** — referring to YantrikClaw in documentation,
...
4. **Fork identification** — identifying your fork as "a fork of YantrikClaw"
...
You **may not** use the YantrikClaw name or marks in ways that:

1. **Imply official endorsement** — suggest your project, product, or
   organization is officially affiliated with or endorsed by YantrikClaw Labs.

2. **Cause brand confusion** — use "YantrikClaw" as the primary name of a
...
3. **Impersonate the project** — create repositories, domains, packages,
   or accounts that could be mistaken for the official YantrikClaw project.

4. **Misrepresent origin** — remove or obscure attribution to YantrikClaw Labs
   while distributing the software or derivatives.

5. **Commercial trademark use** — use the marks in commercial products,
   services, or marketing without prior written permission from YantrikClaw Labs.
...
you fork YantrikClaw, you must:

- Clearly state your project is a fork of YantrikClaw
- Link back to the official repository
- Not use "YantrikClaw" as the primary name of your fork
...
Contributors to the official YantrikClaw repository are protected under the
...
If you believe someone is infringing YantrikClaw trademarks:

1. Open an issue at https://github.com/yantrikclaw-labs/yantrikclaw/issues
...
YantrikClaw Labs reserves the right to update this policy at any time. Changes
...
this policy governs use of the YantrikClaw name and brand.*
