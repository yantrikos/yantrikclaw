# YantrikClaw ESP32 UI Firmware

Slint-based graphical UI firmware scaffold for YantrikClaw edge scenarios on ESP32.
...
3. Connect UI state with YantrikClaw edge/runtime messaging
...
- [YantrikClaw Hardware Design](../../docs/hardware/hardware-peripherals-design.md)
