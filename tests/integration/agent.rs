...
//!
//! Ref: https://github.com/yantrikclaw-labs/yantrikclaw/issues/618 (item 6)
...
use yantrikclaw::providers::traits::ChatMessage;
use yantrikclaw::providers::{ChatResponse, ConversationMessage, ToolCall};
...
async fn e2e_multi_turn_with_memory_enrichment() {
    ...
    assert!(req1_user.content.contains("project: yantrikclaw"));
