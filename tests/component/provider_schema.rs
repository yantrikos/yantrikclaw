...
use yantrikclaw::providers::compatible::AuthStyle;
use yantrikclaw::providers::traits::{ChatMessage, ChatResponse, ToolCall};
...
fn provider_construction_with_different_names() {
    use yantrikclaw::providers::compatible::OpenAiCompatibleProvider;
