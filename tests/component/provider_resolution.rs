...
use yantrikclaw::providers::compatible::{AuthStyle, OpenAiCompatibleProvider};
use yantrikclaw::providers::{
...
fn factory_resolves_openai_codex_provider() {
    let options = yantrikclaw::providers::ProviderRuntimeOptions::default();
