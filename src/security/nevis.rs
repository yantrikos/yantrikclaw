//! Nevis IAM authentication provider for YantrikClaw.
//!
...
//! roles to YantrikClaw tool permissions via [`super::iam_policy::IamPolicy`].
...
mod tests {
    ...
    fn nevis_identity_serde_roundtrip() {
        ...
        assert_eq!(parsed.user_id, "yantrikclaw_user");
