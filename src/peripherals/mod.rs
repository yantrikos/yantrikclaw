...
/// Handle `yantrikclaw peripheral` subcommands.
    ...
    match cmd {
        crate::PeripheralCommands::List => {
            ...
            if boards.is_empty() {
                ...
                println!();
                println!("Add one with: yantrikclaw peripheral add <board> <path>");
                println!("  Example: yantrikclaw peripheral add nucleo-f401re /dev/ttyACM0");
                println!();
