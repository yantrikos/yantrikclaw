...
pub struct EmailConfig {
    ...
    /// Default subject line for outgoing emails (default: "YantrikClaw Message")
...
mod tests {
    ...
    fn email_config_deserialize_with_defaults() {
        ...
        assert_eq!(config.default_subject, "YantrikClaw Message"); // default
    }
