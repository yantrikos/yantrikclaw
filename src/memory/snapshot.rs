...
const SNAPSHOT_HEADER: &str = "# 🧠 YantrikClaw Memory Snapshot\n\n\
    > Auto-generated by YantrikClaw. Do not edit manually unless you know what you're doing.\n\
...
mod tests {
    ...
    fn parse_snapshot_basic() {
        let input = r#"# 🧠 YantrikClaw Memory Snapshot

> Auto-generated by YantrikClaw.
...
I am YantrikClaw, a self-preserving AI agent.
...
"#;
    ...
    fn parse_snapshot_empty() {
        let input = "# 🧠 YantrikClaw Memory Snapshot\n\n> Nothing here.\n";
        let entries = parse_snapshot(input);
